    ...
    class ResponseAPIAuthenticator429ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('detail', $data)) {
                $object->setDetail($this->denormalizer->denormalize($data['detail'], 'KatapultAPI\\Public\\Model\\RateLimitReached', 'json', $context));
                unset($data['detail']);
            }
        ...
        {
            return ['KatapultAPI\\Public\\Model\\ResponseAPIAuthenticator429Response' => false];
        }
    }
} else {
    class ResponseAPIAuthenticator429ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
