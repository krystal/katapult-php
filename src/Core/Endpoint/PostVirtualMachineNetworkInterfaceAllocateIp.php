...
class PostVirtualMachineNetworkInterfaceAllocateIp extends \KatapultAPI\Core\Runtime\Client\BaseEndpoint implements \KatapultAPI\Core\Runtime\Client\Endpoint
{
    ...
    {
        if ($this->body instanceof \KatapultAPI\Core\Model\VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceAllocateIpPostBody) {
    ...
    /**
     * @return \KatapultAPI\Core\Model\VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceAllocateIpPostResponse200|null
     *
     * @throws \KatapultAPI\Core\Exception\PostVirtualMachineNetworkInterfaceAllocateIpBadRequestException
     * @throws \KatapultAPI\Core\Exception\PostVirtualMachineNetworkInterfaceAllocateIpForbiddenException
     * @throws \KatapultAPI\Core\Exception\PostVirtualMachineNetworkInterfaceAllocateIpNotFoundException
     * @throws \KatapultAPI\Core\Exception\PostVirtualMachineNetworkInterfaceAllocateIpUnprocessableEntityException
     * @throws \KatapultAPI\Core\Exception\PostVirtualMachineNetworkInterfaceAllocateIpTooManyRequestsException
     * @throws \KatapultAPI\Core\Exception\PostVirtualMachineNetworkInterfaceAllocateIpServiceUnavailableException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (404 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            throw new \KatapultAPI\Core\Exception\PostVirtualMachineNetworkInterfaceAllocateIpNotFoundException($response);
        }
