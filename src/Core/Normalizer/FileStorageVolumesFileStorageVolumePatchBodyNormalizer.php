    ...
    class FileStorageVolumesFileStorageVolumePatchBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('properties', $data)) {
                $object->setProperties($this->denormalizer->denormalize($data['properties'], 'KatapultAPI\\Core\\Model\\FileStorageVolumeArguments', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\FileStorageVolumesFileStorageVolumePatchBody' => false];
        }
    }
} else {
    class FileStorageVolumesFileStorageVolumePatchBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
