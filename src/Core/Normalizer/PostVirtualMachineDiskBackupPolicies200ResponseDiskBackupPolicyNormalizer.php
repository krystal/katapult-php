...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PostVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\PostVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicy::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\PostVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicy::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\PostVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicy();
        ...
        {
            return [\KatapultAPI\Core\Model\PostVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicy::class => false];
        }
    }
} else {
    class PostVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
