...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetVirtualMachineDiskBackupPolicies200ResponseDiskBackupPoliciesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\GetVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicies::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\GetVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicies::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\GetVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicies();
            ...
            if (\array_key_exists('schedule', $data)) {
                $object->setSchedule($this->denormalizer->denormalize($data['schedule'], \KatapultAPI\Core\Model\GetVirtualMachineDiskBackupPoliciesPartSchedule::class, 'json', $context));
                unset($data['schedule']);
            }
        ...
        {
            return [\KatapultAPI\Core\Model\GetVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicies::class => false];
        }
    }
} else {
    class GetVirtualMachineDiskBackupPolicies200ResponseDiskBackupPoliciesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
