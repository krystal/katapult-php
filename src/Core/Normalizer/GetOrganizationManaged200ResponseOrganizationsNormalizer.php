...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetOrganizationManaged200ResponseOrganizationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\GetOrganizationManaged200ResponseOrganizations';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\GetOrganizationManaged200ResponseOrganizations';
        }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetOrganizationManaged200ResponseOrganizations' => false];
        }
    }
} else {
    class GetOrganizationManaged200ResponseOrganizationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
