...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetVirtualMachinePackages200ResponseVirtualMachinePackagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\GetVirtualMachinePackages200ResponseVirtualMachinePackages';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\GetVirtualMachinePackages200ResponseVirtualMachinePackages';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\GetVirtualMachinePackages200ResponseVirtualMachinePackages();
            ...
            if (\array_key_exists('icon', $data) && $data['icon'] !== null) {
                $object->setIcon($this->denormalizer->denormalize($data['icon'], 'KatapultAPI\\Core\\Model\\GetVirtualMachinePackages200ResponseVirtualMachinePackagesIcon', 'json', $context));
                unset($data['icon']);
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetVirtualMachinePackages200ResponseVirtualMachinePackages' => false];
        }
    }
} else {
    class GetVirtualMachinePackages200ResponseVirtualMachinePackagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
