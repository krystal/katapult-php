...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PostDiskDetach200ResponseDiskVirtualMachineDiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\PostDiskDetach200ResponseDiskVirtualMachineDisk';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\PostDiskDetach200ResponseDiskVirtualMachineDisk';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('virtual_machine', $data)) {
                $object->setVirtualMachine($this->denormalizer->denormalize($data['virtual_machine'], 'KatapultAPI\\Core\\Model\\PostDiskDetachPartVirtualMachine', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\PostDiskDetach200ResponseDiskVirtualMachineDisk' => false];
        }
    }
} else {
    class PostDiskDetach200ResponseDiskVirtualMachineDiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
