...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PatchVirtualMachine200ResponseVirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachine';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachine';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\PatchVirtualMachine200ResponseVirtualMachine();
            ...
            if (\array_key_exists('organization', $data)) {
                $object->setOrganization($this->denormalizer->denormalize($data['organization'], 'KatapultAPI\\Core\\Model\\Organization', 'json', $context));
                unset($data['organization']);
            }
            if (\array_key_exists('group', $data) && $data['group'] !== null) {
                $object->setGroup($this->denormalizer->denormalize($data['group'], 'KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachineGroup', 'json', $context));
                unset($data['group']);
            } elseif (\array_key_exists('group', $data) && $data['group'] === null) {
                $object->setGroup(null);
            }
            if (\array_key_exists('package', $data) && $data['package'] !== null) {
                $object->setPackage($this->denormalizer->denormalize($data['package'], 'KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachinePackage', 'json', $context));
                unset($data['package']);
            ...
            if (\array_key_exists('attached_iso', $data) && $data['attached_iso'] !== null) {
                $object->setAttachedIso($this->denormalizer->denormalize($data['attached_iso'], 'KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachineAttachedIso', 'json', $context));
            ...
            if (\array_key_exists('gpu_type', $data) && $data['gpu_type'] !== null) {
                $object->setGpuType($this->denormalizer->denormalize($data['gpu_type'], 'KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachineGpuType', 'json', $context));
                unset($data['gpu_type']);
            ...
            if (\array_key_exists('gpus', $data)) {
                ...
                foreach ($data['gpus'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'KatapultAPI\\Core\\Model\\VirtualMachineGPU', 'json', $context);
                }
            ...
            if (\array_key_exists('tags', $data)) {
                ...
                foreach ($data['tags'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'KatapultAPI\\Core\\Model\\Tag', 'json', $context);
                }
            ...
            if (\array_key_exists('ip_addresses', $data)) {
                ...
                foreach ($data['ip_addresses'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'KatapultAPI\\Core\\Model\\IPAddress', 'json', $context);
                }
                $object->setIpAddresses($values_3);
                unset($data['ip_addresses']);
            }
            if (\array_key_exists('hypervisor', $data) && $data['hypervisor'] !== null) {
                $object->setHypervisor($this->denormalizer->denormalize($data['hypervisor'], 'KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachineHypervisor', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\PatchVirtualMachine200ResponseVirtualMachine' => false];
        }
    }
} else {
    class PatchVirtualMachine200ResponseVirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
