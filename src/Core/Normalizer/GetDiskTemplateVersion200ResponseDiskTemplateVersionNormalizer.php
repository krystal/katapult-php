...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetDiskTemplateVersion200ResponseDiskTemplateVersionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\GetDiskTemplateVersion200ResponseDiskTemplateVersion';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\GetDiskTemplateVersion200ResponseDiskTemplateVersion';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('disk_template', $data)) {
                $object->setDiskTemplate($this->denormalizer->denormalize($data['disk_template'], 'KatapultAPI\\Core\\Model\\GetDiskTemplateVersionPartDiskTemplate', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetDiskTemplateVersion200ResponseDiskTemplateVersion' => false];
        }
    }
} else {
    class GetDiskTemplateVersion200ResponseDiskTemplateVersionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
