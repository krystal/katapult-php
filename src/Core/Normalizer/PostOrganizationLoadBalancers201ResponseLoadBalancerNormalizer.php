...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PostOrganizationLoadBalancers201ResponseLoadBalancerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\PostOrganizationLoadBalancers201ResponseLoadBalancer::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\PostOrganizationLoadBalancers201ResponseLoadBalancer::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\PostOrganizationLoadBalancers201ResponseLoadBalancer();
        ...
        {
            return [\KatapultAPI\Core\Model\PostOrganizationLoadBalancers201ResponseLoadBalancer::class => false];
        }
    }
} else {
    class PostOrganizationLoadBalancers201ResponseLoadBalancerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
