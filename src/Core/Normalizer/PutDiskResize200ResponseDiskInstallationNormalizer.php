...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PutDiskResize200ResponseDiskInstallationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\PutDiskResize200ResponseDiskInstallation';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\PutDiskResize200ResponseDiskInstallation';
        }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\PutDiskResize200ResponseDiskInstallation' => false];
        }
    }
} else {
    class PutDiskResize200ResponseDiskInstallationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
