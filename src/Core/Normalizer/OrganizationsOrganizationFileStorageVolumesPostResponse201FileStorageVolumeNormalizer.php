    ...
    class OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'KatapultAPI\\Core\\Model\\PostOrganizationFileStorageVolumesPartDataCenter', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolume' => false];
        }
    }
} else {
    class OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
