...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolume::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolume::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolume();
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], \KatapultAPI\Core\Model\PostOrganizationFileStorageVolumesPartDataCenter::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolume::class => false];
        }
    }
} else {
    class OrganizationsOrganizationFileStorageVolumesPostResponse201FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
