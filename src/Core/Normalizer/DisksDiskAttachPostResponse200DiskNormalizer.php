...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DisksDiskAttachPostResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\DisksDiskAttachPostResponse200Disk::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\DisksDiskAttachPostResponse200Disk::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\DisksDiskAttachPostResponse200Disk();
            ...
            if (\array_key_exists('io_profile', $data) && $data['io_profile'] !== null) {
                $object->setIoProfile($this->denormalizer->denormalize($data['io_profile'], \KatapultAPI\Core\Model\PostDiskAttach200ResponseDiskIoProfile::class, 'json', $context));
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], \KatapultAPI\Core\Model\PostDiskAttachPartDataCenter::class, 'json', $context));
                unset($data['data_center']);
            }
            if (\array_key_exists('virtual_machine_disk', $data) && $data['virtual_machine_disk'] !== null) {
                $object->setVirtualMachineDisk($this->denormalizer->denormalize($data['virtual_machine_disk'], \KatapultAPI\Core\Model\PostDiskAttach200ResponseDiskVirtualMachineDisk::class, 'json', $context));
            ...
            if (\array_key_exists('installation', $data) && $data['installation'] !== null) {
                $object->setInstallation($this->denormalizer->denormalize($data['installation'], \KatapultAPI\Core\Model\PostDiskAttach200ResponseDiskInstallation::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\DisksDiskAttachPostResponse200Disk::class => false];
        }
    }
} else {
    class DisksDiskAttachPostResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
