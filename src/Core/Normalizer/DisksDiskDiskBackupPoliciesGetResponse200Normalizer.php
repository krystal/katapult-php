...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DisksDiskDiskBackupPoliciesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('disk_backup_policies', $data)) {
                ...
                foreach ($data['disk_backup_policies'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'KatapultAPI\\Core\\Model\\GetDiskDiskBackupPolicies200ResponseDiskBackupPolicies', 'json', $context);
                }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\DisksDiskDiskBackupPoliciesGetResponse200' => false];
        }
    }
} else {
    class DisksDiskDiskBackupPoliciesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
