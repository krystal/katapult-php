    ...
    class GetOrganizationAvailableNetworks200ResponseVirtualNetworksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'KatapultAPI\\Core\\Model\\GetOrganizationAvailableNetworksPartDataCenter', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetOrganizationAvailableNetworks200ResponseVirtualNetworks' => false];
        }
    }
} else {
    class GetOrganizationAvailableNetworks200ResponseVirtualNetworksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
