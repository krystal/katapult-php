...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetVirtualMachineDisks200ResponseDisksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\GetVirtualMachineDisks200ResponseDisks';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\GetVirtualMachineDisks200ResponseDisks';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('disk', $data)) {
                $object->setDisk($this->denormalizer->denormalize($data['disk'], 'KatapultAPI\\Core\\Model\\GetVirtualMachineDisksPartDisk', 'json', $context));
                unset($data['disk']);
            }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetVirtualMachineDisks200ResponseDisks' => false];
        }
    }
} else {
    class GetVirtualMachineDisks200ResponseDisksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
