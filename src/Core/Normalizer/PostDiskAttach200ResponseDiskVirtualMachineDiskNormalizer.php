...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PostDiskAttach200ResponseDiskVirtualMachineDiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\PostDiskAttach200ResponseDiskVirtualMachineDisk::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\PostDiskAttach200ResponseDiskVirtualMachineDisk::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\PostDiskAttach200ResponseDiskVirtualMachineDisk();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('virtual_machine', $data)) {
                $object->setVirtualMachine($this->denormalizer->denormalize($data['virtual_machine'], \KatapultAPI\Core\Model\PostDiskAttachPartVirtualMachine::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\PostDiskAttach200ResponseDiskVirtualMachineDisk::class => false];
        }
    }
} else {
    class PostDiskAttach200ResponseDiskVirtualMachineDiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
