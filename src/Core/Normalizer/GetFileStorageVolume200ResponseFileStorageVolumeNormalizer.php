...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetFileStorageVolume200ResponseFileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\GetFileStorageVolume200ResponseFileStorageVolume';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\GetFileStorageVolume200ResponseFileStorageVolume';
        }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetFileStorageVolume200ResponseFileStorageVolume' => false];
        }
    }
} else {
    class GetFileStorageVolume200ResponseFileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
