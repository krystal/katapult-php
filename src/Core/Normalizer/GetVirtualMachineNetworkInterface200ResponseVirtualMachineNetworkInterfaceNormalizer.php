...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterface::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterface::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterface();
            ...
            if (\array_key_exists('virtual_machine', $data)) {
                $object->setVirtualMachine($this->denormalizer->denormalize($data['virtual_machine'], \KatapultAPI\Core\Model\GetVirtualMachineNetworkInterfacePartVirtualMachine::class, 'json', $context));
            ...
            if (\array_key_exists('network', $data) && $data['network'] !== null) {
                $object->setNetwork($this->denormalizer->denormalize($data['network'], \KatapultAPI\Core\Model\GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterfaceNetwork::class, 'json', $context));
                unset($data['network']);
            ...
            if (\array_key_exists('virtual_network', $data) && $data['virtual_network'] !== null) {
                $object->setVirtualNetwork($this->denormalizer->denormalize($data['virtual_network'], \KatapultAPI\Core\Model\GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterfaceVirtualNetwork::class, 'json', $context));
            ...
            if (\array_key_exists('ip_addresses', $data)) {
                ...
                foreach ($data['ip_addresses'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \KatapultAPI\Core\Model\GetVirtualMachineNetworkInterfacePartIPAddresses::class, 'json', $context);
                }
        ...
        {
            return [\KatapultAPI\Core\Model\GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterface::class => false];
        }
    }
} else {
    class GetVirtualMachineNetworkInterface200ResponseVirtualMachineNetworkInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
