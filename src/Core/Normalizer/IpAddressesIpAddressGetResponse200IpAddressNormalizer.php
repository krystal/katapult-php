...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class IpAddressesIpAddressGetResponse200IpAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\IpAddressesIpAddressGetResponse200IpAddress::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\IpAddressesIpAddressGetResponse200IpAddress::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\IpAddressesIpAddressGetResponse200IpAddress();
        ...
        {
            return [\KatapultAPI\Core\Model\IpAddressesIpAddressGetResponse200IpAddress::class => false];
        }
    }
} else {
    class IpAddressesIpAddressGetResponse200IpAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
