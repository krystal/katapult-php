    ...
    class OrganizationsOrganizationLoadBalancersPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('load_balancer', $data)) {
                $object->setLoadBalancer($this->denormalizer->denormalize($data['load_balancer'], 'KatapultAPI\\Core\\Model\\OrganizationsOrganizationLoadBalancersPostResponse201LoadBalancer', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\OrganizationsOrganizationLoadBalancersPostResponse201' => false];
        }
    }
} else {
    class OrganizationsOrganizationLoadBalancersPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
