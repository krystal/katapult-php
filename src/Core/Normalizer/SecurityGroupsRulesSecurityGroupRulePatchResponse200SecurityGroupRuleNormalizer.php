...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SecurityGroupsRulesSecurityGroupRulePatchResponse200SecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\SecurityGroupsRulesSecurityGroupRulePatchResponse200SecurityGroupRule::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\SecurityGroupsRulesSecurityGroupRulePatchResponse200SecurityGroupRule::class;
        }
        ...
        {
            return [\KatapultAPI\Core\Model\SecurityGroupsRulesSecurityGroupRulePatchResponse200SecurityGroupRule::class => false];
        }
    }
} else {
    class SecurityGroupsRulesSecurityGroupRulePatchResponse200SecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
