...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRule';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRule';
        }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRule' => false];
        }
    }
} else {
    class PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
