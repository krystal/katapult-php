...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRule::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRule::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRule();
            ...
            if (\array_key_exists('security_group', $data)) {
                $object->setSecurityGroup($this->denormalizer->denormalize($data['security_group'], \KatapultAPI\Core\Model\PatchSecurityGroupsRulesSecurityGroupRulePartSecurityGroup::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRule::class => false];
        }
    }
} else {
    class PatchSecurityGroupsRulesSecurityGroupRule200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
