...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LoadBalancersLoadBalancerPatchResponse200LoadBalancerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\LoadBalancersLoadBalancerPatchResponse200LoadBalancer::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\LoadBalancersLoadBalancerPatchResponse200LoadBalancer::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\LoadBalancersLoadBalancerPatchResponse200LoadBalancer();
            ...
            if (\array_key_exists('ip_address', $data)) {
                $object->setIpAddress($this->denormalizer->denormalize($data['ip_address'], \KatapultAPI\Core\Model\PatchLoadBalancerPartIPAddress::class, 'json', $context));
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], \KatapultAPI\Core\Model\PatchLoadBalancerPartDataCenter::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\LoadBalancersLoadBalancerPatchResponse200LoadBalancer::class => false];
        }
    }
} else {
    class LoadBalancersLoadBalancerPatchResponse200LoadBalancerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
