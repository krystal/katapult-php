...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetVirtualMachine200ResponseVirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachine::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachine::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('group', $data) && $data['group'] !== null) {
                $object->setGroup($this->denormalizer->denormalize($data['group'], \KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachineGroup::class, 'json', $context));
                unset($data['group']);
            } elseif (\array_key_exists('group', $data) && $data['group'] === null) {
                $object->setGroup(null);
            }
            if (\array_key_exists('package', $data) && $data['package'] !== null) {
                $object->setPackage($this->denormalizer->denormalize($data['package'], \KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachinePackage::class, 'json', $context));
                unset($data['package']);
            ...
            if (\array_key_exists('attached_iso', $data) && $data['attached_iso'] !== null) {
                $object->setAttachedIso($this->denormalizer->denormalize($data['attached_iso'], \KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachineAttachedIso::class, 'json', $context));
            ...
            if (\array_key_exists('gpu_type', $data) && $data['gpu_type'] !== null) {
                $object->setGpuType($this->denormalizer->denormalize($data['gpu_type'], \KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachineGpuType::class, 'json', $context));
                unset($data['gpu_type']);
            ...
            if (\array_key_exists('hypervisor', $data) && $data['hypervisor'] !== null) {
                $object->setHypervisor($this->denormalizer->denormalize($data['hypervisor'], \KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachineHypervisor::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\GetVirtualMachine200ResponseVirtualMachine::class => false];
        }
    }
} else {
    class GetVirtualMachine200ResponseVirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
