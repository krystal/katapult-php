    ...
    class VirtualMachinesVirtualMachinePatchResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('virtual_machine', $data)) {
                $object->setVirtualMachine($this->denormalizer->denormalize($data['virtual_machine'], 'KatapultAPI\\Core\\Model\\VirtualMachinesVirtualMachinePatchResponse200VirtualMachine', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\VirtualMachinesVirtualMachinePatchResponse200' => false];
        }
    }
} else {
    class VirtualMachinesVirtualMachinePatchResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
