...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FileStorageVolumesFileStorageVolumeDeleteResponse200FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\FileStorageVolumesFileStorageVolumeDeleteResponse200FileStorageVolume::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\FileStorageVolumesFileStorageVolumeDeleteResponse200FileStorageVolume::class;
        }
        ...
        {
            return [\KatapultAPI\Core\Model\FileStorageVolumesFileStorageVolumeDeleteResponse200FileStorageVolume::class => false];
        }
    }
} else {
    class FileStorageVolumesFileStorageVolumeDeleteResponse200FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
