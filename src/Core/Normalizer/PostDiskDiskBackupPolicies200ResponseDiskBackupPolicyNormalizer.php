...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PostDiskDiskBackupPolicies200ResponseDiskBackupPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\PostDiskDiskBackupPolicies200ResponseDiskBackupPolicy';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\PostDiskDiskBackupPolicies200ResponseDiskBackupPolicy';
        }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\PostDiskDiskBackupPolicies200ResponseDiskBackupPolicy' => false];
        }
    }
} else {
    class PostDiskDiskBackupPolicies200ResponseDiskBackupPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
