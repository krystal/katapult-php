...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DisksDiskIoProfilePutResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\DisksDiskIoProfilePutResponse200Disk';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\DisksDiskIoProfilePutResponse200Disk';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('io_profile', $data) && $data['io_profile'] !== null) {
                $object->setIoProfile($this->denormalizer->denormalize($data['io_profile'], 'KatapultAPI\\Core\\Model\\PutDiskIOProfile200ResponseDiskIoProfile', 'json', $context));
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'KatapultAPI\\Core\\Model\\PutDiskIOProfilePartDataCenter', 'json', $context));
                unset($data['data_center']);
            }
            if (\array_key_exists('virtual_machine_disk', $data) && $data['virtual_machine_disk'] !== null) {
                $object->setVirtualMachineDisk($this->denormalizer->denormalize($data['virtual_machine_disk'], 'KatapultAPI\\Core\\Model\\PutDiskIOProfile200ResponseDiskVirtualMachineDisk', 'json', $context));
            ...
            if (\array_key_exists('installation', $data) && $data['installation'] !== null) {
                $object->setInstallation($this->denormalizer->denormalize($data['installation'], 'KatapultAPI\\Core\\Model\\PutDiskIOProfile200ResponseDiskInstallation', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\DisksDiskIoProfilePutResponse200Disk' => false];
        }
    }
} else {
    class DisksDiskIoProfilePutResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
