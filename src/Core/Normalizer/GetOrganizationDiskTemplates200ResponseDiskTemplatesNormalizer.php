...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetOrganizationDiskTemplates200ResponseDiskTemplatesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\GetOrganizationDiskTemplates200ResponseDiskTemplates::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\GetOrganizationDiskTemplates200ResponseDiskTemplates::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\GetOrganizationDiskTemplates200ResponseDiskTemplates();
            ...
            if (\array_key_exists('latest_version', $data) && $data['latest_version'] !== null) {
                $object->setLatestVersion($this->denormalizer->denormalize($data['latest_version'], \KatapultAPI\Core\Model\GetOrganizationDiskTemplates200ResponseDiskTemplatesLatestVersion::class, 'json', $context));
            ...
            if (\array_key_exists('operating_system', $data) && $data['operating_system'] !== null) {
                $object->setOperatingSystem($this->denormalizer->denormalize($data['operating_system'], \KatapultAPI\Core\Model\GetOrganizationDiskTemplates200ResponseDiskTemplatesOperatingSystem::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\GetOrganizationDiskTemplates200ResponseDiskTemplates::class => false];
        }
    }
} else {
    class GetOrganizationDiskTemplates200ResponseDiskTemplatesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
