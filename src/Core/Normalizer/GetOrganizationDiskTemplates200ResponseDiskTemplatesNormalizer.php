    ...
    class GetOrganizationDiskTemplates200ResponseDiskTemplatesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('latest_version', $data) && $data['latest_version'] !== null) {
                $object->setLatestVersion($this->denormalizer->denormalize($data['latest_version'], 'KatapultAPI\\Core\\Model\\GetOrganizationDiskTemplates200ResponseDiskTemplatesLatestVersion', 'json', $context));
            ...
            if (\array_key_exists('operating_system', $data) && $data['operating_system'] !== null) {
                $object->setOperatingSystem($this->denormalizer->denormalize($data['operating_system'], 'KatapultAPI\\Core\\Model\\GetOrganizationDiskTemplates200ResponseDiskTemplatesOperatingSystem', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetOrganizationDiskTemplates200ResponseDiskTemplates' => false];
        }
    }
} else {
    class GetOrganizationDiskTemplates200ResponseDiskTemplatesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
