...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FileStorageVolumesFileStorageVolumeGetResponse200FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\FileStorageVolumesFileStorageVolumeGetResponse200FileStorageVolume';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\FileStorageVolumesFileStorageVolumeGetResponse200FileStorageVolume';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'KatapultAPI\\Core\\Model\\GetFileStorageVolumePartDataCenter', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\FileStorageVolumesFileStorageVolumeGetResponse200FileStorageVolume' => false];
        }
    }
} else {
    class FileStorageVolumesFileStorageVolumeGetResponse200FileStorageVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
