    ...
    class ScopeNotGrantedErrorSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('detail', $data)) {
                $object->setDetail($this->denormalizer->denormalize($data['detail'], 'KatapultAPI\\Core\\Model\\ScopeNotGrantedError', 'json', $context));
                unset($data['detail']);
            }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\ScopeNotGrantedErrorSchema' => false];
        }
    }
} else {
    class ScopeNotGrantedErrorSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
