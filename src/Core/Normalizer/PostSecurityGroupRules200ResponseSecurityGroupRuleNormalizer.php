...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PostSecurityGroupRules200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\PostSecurityGroupRules200ResponseSecurityGroupRule::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\PostSecurityGroupRules200ResponseSecurityGroupRule::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\PostSecurityGroupRules200ResponseSecurityGroupRule();
            ...
            if (\array_key_exists('security_group', $data)) {
                $object->setSecurityGroup($this->denormalizer->denormalize($data['security_group'], \KatapultAPI\Core\Model\PostSecurityGroupRulesPartSecurityGroup::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\PostSecurityGroupRules200ResponseSecurityGroupRule::class => false];
        }
    }
} else {
    class PostSecurityGroupRules200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
