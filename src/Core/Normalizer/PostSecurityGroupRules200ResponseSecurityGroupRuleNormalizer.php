    ...
    class PostSecurityGroupRules200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('security_group', $data)) {
                $object->setSecurityGroup($this->denormalizer->denormalize($data['security_group'], 'KatapultAPI\\Core\\Model\\PostSecurityGroupRulesPartSecurityGroup', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\PostSecurityGroupRules200ResponseSecurityGroupRule' => false];
        }
    }
} else {
    class PostSecurityGroupRules200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
