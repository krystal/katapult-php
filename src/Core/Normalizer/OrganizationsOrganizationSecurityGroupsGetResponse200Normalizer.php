...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OrganizationsOrganizationSecurityGroupsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\OrganizationsOrganizationSecurityGroupsGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\OrganizationsOrganizationSecurityGroupsGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\OrganizationsOrganizationSecurityGroupsGetResponse200();
            ...
            if (\array_key_exists('security_groups', $data)) {
                ...
                foreach ($data['security_groups'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \KatapultAPI\Core\Model\SecurityGroup::class, 'json', $context);
                }
        ...
        {
            return [\KatapultAPI\Core\Model\OrganizationsOrganizationSecurityGroupsGetResponse200::class => false];
        }
    }
} else {
    class OrganizationsOrganizationSecurityGroupsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
