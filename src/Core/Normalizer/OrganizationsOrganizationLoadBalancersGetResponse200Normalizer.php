...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OrganizationsOrganizationLoadBalancersGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('load_balancers', $data)) {
                ...
                foreach ($data['load_balancers'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'KatapultAPI\\Core\\Model\\GetOrganizationLoadBalancers200ResponseLoadBalancers', 'json', $context);
                }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\OrganizationsOrganizationLoadBalancersGetResponse200' => false];
        }
    }
} else {
    class OrganizationsOrganizationLoadBalancersGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
