...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetGPUTypes200ResponseGPUTypesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\GetGPUTypes200ResponseGPUTypes';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\GetGPUTypes200ResponseGPUTypes';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('data_centers', $data)) {
                ...
                foreach ($data['data_centers'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'KatapultAPI\\Core\\Model\\GetGPUTypes200ResponseGPUTypesDataCentersItem', 'json', $context);
                }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetGPUTypes200ResponseGPUTypes' => false];
        }
    }
} else {
    class GetGPUTypes200ResponseGPUTypesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
