...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VirtualMachinesVirtualMachinePatchResponse200VirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\VirtualMachinesVirtualMachinePatchResponse200VirtualMachine::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\VirtualMachinesVirtualMachinePatchResponse200VirtualMachine::class;
        }
        ...
        {
            return [\KatapultAPI\Core\Model\VirtualMachinesVirtualMachinePatchResponse200VirtualMachine::class => false];
        }
    }
} else {
    class VirtualMachinesVirtualMachinePatchResponse200VirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
