...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VirtualMachinesVirtualMachinePatchResponse200VirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\VirtualMachinesVirtualMachinePatchResponse200VirtualMachine();
        ...
        {
            return ['KatapultAPI\\Core\\Model\\VirtualMachinesVirtualMachinePatchResponse200VirtualMachine' => false];
        }
    }
} else {
    class VirtualMachinesVirtualMachinePatchResponse200VirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
