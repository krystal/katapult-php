    ...
    class GetDataCenter200ResponseDataCenterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('country', $data)) {
                $object->setCountry($this->denormalizer->denormalize($data['country'], 'KatapultAPI\\Core\\Model\\GetDataCenterPartCountry', 'json', $context));
                unset($data['country']);
            }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetDataCenter200ResponseDataCenter' => false];
        }
    }
} else {
    class GetDataCenter200ResponseDataCenterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
