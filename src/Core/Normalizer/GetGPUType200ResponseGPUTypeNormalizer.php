...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GetGPUType200ResponseGPUTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\GetGPUType200ResponseGPUType';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\GetGPUType200ResponseGPUType';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('data_centers', $data)) {
                ...
                foreach ($data['data_centers'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'KatapultAPI\\Core\\Model\\GetGPUType200ResponseGPUTypeDataCentersItem', 'json', $context);
                }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\GetGPUType200ResponseGPUType' => false];
        }
    }
} else {
    class GetGPUType200ResponseGPUTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
