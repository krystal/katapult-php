    ...
    class UnauthorizedNetworkForAPITokenSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('detail', $data)) {
                $object->setDetail($this->denormalizer->denormalize($data['detail'], 'KatapultAPI\\Core\\Model\\UnauthorizedNetworkForAPIToken', 'json', $context));
                unset($data['detail']);
            }
        ...
        {
            return ['KatapultAPI\\Core\\Model\\UnauthorizedNetworkForAPITokenSchema' => false];
        }
    }
} else {
    class UnauthorizedNetworkForAPITokenSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
