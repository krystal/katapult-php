    ...
    class OrganizationsOrganizationVirtualMachinesBuildFromSpecPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('task', $data)) {
                $object->setTask($this->denormalizer->denormalize($data['task'], 'KatapultAPI\\Core\\Model\\PostOrganizationVirtualMachinesBuildFromSpec201ResponseTask', 'json', $context));
                unset($data['task']);
            }
            if (\array_key_exists('build', $data)) {
                $object->setBuild($this->denormalizer->denormalize($data['build'], 'KatapultAPI\\Core\\Model\\OrganizationsOrganizationVirtualMachinesBuildFromSpecPostResponse201Build', 'json', $context));
                unset($data['build']);
            }
            if (\array_key_exists('virtual_machine_build', $data)) {
                $object->setVirtualMachineBuild($this->denormalizer->denormalize($data['virtual_machine_build'], 'KatapultAPI\\Core\\Model\\PostOrganizationVirtualMachinesBuildFromSpec201ResponseVirtualMachineBuild', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\OrganizationsOrganizationVirtualMachinesBuildFromSpecPostResponse201' => false];
        }
    }
} else {
    class OrganizationsOrganizationVirtualMachinesBuildFromSpecPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
