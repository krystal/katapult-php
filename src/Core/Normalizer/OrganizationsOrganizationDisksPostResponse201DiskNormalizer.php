...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OrganizationsOrganizationDisksPostResponse201DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\OrganizationsOrganizationDisksPostResponse201Disk';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\OrganizationsOrganizationDisksPostResponse201Disk';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('io_profile', $data) && $data['io_profile'] !== null) {
                $object->setIoProfile($this->denormalizer->denormalize($data['io_profile'], 'KatapultAPI\\Core\\Model\\PostOrganizationDisks201ResponseDiskIoProfile', 'json', $context));
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'KatapultAPI\\Core\\Model\\PostOrganizationDisksPartDataCenter', 'json', $context));
                unset($data['data_center']);
            }
            if (\array_key_exists('virtual_machine_disk', $data) && $data['virtual_machine_disk'] !== null) {
                $object->setVirtualMachineDisk($this->denormalizer->denormalize($data['virtual_machine_disk'], 'KatapultAPI\\Core\\Model\\PostOrganizationDisks201ResponseDiskVirtualMachineDisk', 'json', $context));
            ...
            if (\array_key_exists('installation', $data) && $data['installation'] !== null) {
                $object->setInstallation($this->denormalizer->denormalize($data['installation'], 'KatapultAPI\\Core\\Model\\PostOrganizationDisks201ResponseDiskInstallation', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\OrganizationsOrganizationDisksPostResponse201Disk' => false];
        }
    }
} else {
    class OrganizationsOrganizationDisksPostResponse201DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
