    ...
    class LoadBalancersLoadBalancerPatchResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('load_balancer', $data)) {
                $object->setLoadBalancer($this->denormalizer->denormalize($data['load_balancer'], 'KatapultAPI\\Core\\Model\\LoadBalancersLoadBalancerPatchResponse200LoadBalancer', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\LoadBalancersLoadBalancerPatchResponse200' => false];
        }
    }
} else {
    class LoadBalancersLoadBalancerPatchResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
