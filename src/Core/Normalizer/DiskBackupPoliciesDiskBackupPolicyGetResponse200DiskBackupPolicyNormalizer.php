...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DiskBackupPoliciesDiskBackupPolicyGetResponse200DiskBackupPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\DiskBackupPoliciesDiskBackupPolicyGetResponse200DiskBackupPolicy::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\DiskBackupPoliciesDiskBackupPolicyGetResponse200DiskBackupPolicy::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\DiskBackupPoliciesDiskBackupPolicyGetResponse200DiskBackupPolicy();
        ...
        {
            return [\KatapultAPI\Core\Model\DiskBackupPoliciesDiskBackupPolicyGetResponse200DiskBackupPolicy::class => false];
        }
    }
} else {
    class DiskBackupPoliciesDiskBackupPolicyGetResponse200DiskBackupPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
