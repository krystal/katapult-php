...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VirtualMachinesVirtualMachineDiskBackupPoliciesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\VirtualMachinesVirtualMachineDiskBackupPoliciesGetResponse200::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\VirtualMachinesVirtualMachineDiskBackupPoliciesGetResponse200::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\VirtualMachinesVirtualMachineDiskBackupPoliciesGetResponse200();
            ...
            if (\array_key_exists('disk_backup_policies', $data)) {
                ...
                foreach ($data['disk_backup_policies'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \KatapultAPI\Core\Model\GetVirtualMachineDiskBackupPolicies200ResponseDiskBackupPolicies::class, 'json', $context);
                }
        ...
        {
            return [\KatapultAPI\Core\Model\VirtualMachinesVirtualMachineDiskBackupPoliciesGetResponse200::class => false];
        }
    }
} else {
    class VirtualMachinesVirtualMachineDiskBackupPoliciesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
