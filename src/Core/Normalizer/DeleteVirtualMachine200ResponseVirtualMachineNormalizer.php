...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DeleteVirtualMachine200ResponseVirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachine';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachine';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('group', $data) && $data['group'] !== null) {
                $object->setGroup($this->denormalizer->denormalize($data['group'], 'KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachineGroup', 'json', $context));
                unset($data['group']);
            } elseif (\array_key_exists('group', $data) && $data['group'] === null) {
                $object->setGroup(null);
            }
            if (\array_key_exists('package', $data) && $data['package'] !== null) {
                $object->setPackage($this->denormalizer->denormalize($data['package'], 'KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachinePackage', 'json', $context));
                unset($data['package']);
            ...
            if (\array_key_exists('attached_iso', $data) && $data['attached_iso'] !== null) {
                $object->setAttachedIso($this->denormalizer->denormalize($data['attached_iso'], 'KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachineAttachedIso', 'json', $context));
            ...
            if (\array_key_exists('gpu_type', $data) && $data['gpu_type'] !== null) {
                $object->setGpuType($this->denormalizer->denormalize($data['gpu_type'], 'KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachineGpuType', 'json', $context));
                unset($data['gpu_type']);
            ...
            if (\array_key_exists('hypervisor', $data) && $data['hypervisor'] !== null) {
                $object->setHypervisor($this->denormalizer->denormalize($data['hypervisor'], 'KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachineHypervisor', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\DeleteVirtualMachine200ResponseVirtualMachine' => false];
        }
    }
} else {
    class DeleteVirtualMachine200ResponseVirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
