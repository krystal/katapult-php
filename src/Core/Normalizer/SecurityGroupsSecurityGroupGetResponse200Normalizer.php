    ...
    class SecurityGroupsSecurityGroupGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('security_group', $data)) {
                $object->setSecurityGroup($this->denormalizer->denormalize($data['security_group'], 'KatapultAPI\\Core\\Model\\SecurityGroupsSecurityGroupGetResponse200SecurityGroup', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\SecurityGroupsSecurityGroupGetResponse200' => false];
        }
    }
} else {
    class SecurityGroupsSecurityGroupGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
