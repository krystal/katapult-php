...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class LoadBalancersLoadBalancerRulesPostResponse200LoadBalancerRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\LoadBalancersLoadBalancerRulesPostResponse200LoadBalancerRule::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\LoadBalancersLoadBalancerRulesPostResponse200LoadBalancerRule::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\LoadBalancersLoadBalancerRulesPostResponse200LoadBalancerRule();
            ...
            if (\array_key_exists('certificates', $data)) {
                ...
                foreach ($data['certificates'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \KatapultAPI\Core\Model\PostLoadBalancerRulesPartCertificates::class, 'json', $context);
                }
            ...
            if (\array_key_exists('load_balancer', $data)) {
                $object->setLoadBalancer($this->denormalizer->denormalize($data['load_balancer'], \KatapultAPI\Core\Model\PostLoadBalancerRulesPartLoadBalancer::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\LoadBalancersLoadBalancerRulesPostResponse200LoadBalancerRule::class => false];
        }
    }
} else {
    class LoadBalancersLoadBalancerRulesPostResponse200LoadBalancerRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
