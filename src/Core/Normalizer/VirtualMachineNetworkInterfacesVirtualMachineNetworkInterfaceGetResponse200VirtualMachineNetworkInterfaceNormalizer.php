...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceGetResponse200VirtualMachineNetworkInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \KatapultAPI\Core\Model\VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceGetResponse200VirtualMachineNetworkInterface::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \KatapultAPI\Core\Model\VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceGetResponse200VirtualMachineNetworkInterface::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \KatapultAPI\Core\Model\VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceGetResponse200VirtualMachineNetworkInterface();
            ...
            if (\array_key_exists('virtual_machine', $data)) {
                $object->setVirtualMachine($this->denormalizer->denormalize($data['virtual_machine'], \KatapultAPI\Core\Model\GetVMNIVMNIPartVirtualMachine::class, 'json', $context));
            ...
            if (\array_key_exists('network', $data) && $data['network'] !== null) {
                $object->setNetwork($this->denormalizer->denormalize($data['network'], \KatapultAPI\Core\Model\GetVMNIVMNI200ResponseVirtualMachineNetworkInterfaceNetwork::class, 'json', $context));
                unset($data['network']);
            ...
            if (\array_key_exists('virtual_network', $data) && $data['virtual_network'] !== null) {
                $object->setVirtualNetwork($this->denormalizer->denormalize($data['virtual_network'], \KatapultAPI\Core\Model\GetVMNIVMNI200ResponseVirtualMachineNetworkInterfaceVirtualNetwork::class, 'json', $context));
            ...
            if (\array_key_exists('ip_addresses', $data)) {
                ...
                foreach ($data['ip_addresses'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \KatapultAPI\Core\Model\GetVMNIVMNIPartIPAddresses::class, 'json', $context);
                }
                $object->setIpAddresses($values);
                unset($data['ip_addresses']);
            }
            if (\array_key_exists('speed_profile', $data)) {
                $object->setSpeedProfile($this->denormalizer->denormalize($data['speed_profile'], \KatapultAPI\Core\Model\GetVMNIVMNIPartSpeedProfile::class, 'json', $context));
        ...
        {
            return [\KatapultAPI\Core\Model\VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceGetResponse200VirtualMachineNetworkInterface::class => false];
        }
    }
} else {
    class VirtualMachineNetworkInterfacesVirtualMachineNetworkInterfaceGetResponse200VirtualMachineNetworkInterfaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
