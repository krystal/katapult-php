    ...
    class VirtualMachinesVirtualMachineGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('virtual_machine', $data)) {
                $object->setVirtualMachine($this->denormalizer->denormalize($data['virtual_machine'], 'KatapultAPI\\Core\\Model\\GetVirtualMachine200ResponseVirtualMachine', 'json', $context));
        ...
        {
            return ['KatapultAPI\\Core\\Model\\VirtualMachinesVirtualMachineGetResponse200' => false];
        }
    }
} else {
    class VirtualMachinesVirtualMachineGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
