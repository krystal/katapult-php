...
class VirtualMachinePackagesVirtualMachinePackageGetResponse200VirtualMachinePackage extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    public function getIcon(): Attachment
    {
        return $this->icon;
    }

    public function setIcon(Attachment $icon): self
    {
