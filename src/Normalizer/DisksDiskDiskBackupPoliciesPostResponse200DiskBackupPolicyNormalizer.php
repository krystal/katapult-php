...
class DisksDiskDiskBackupPoliciesPostResponse200DiskBackupPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskDiskBackupPoliciesPostResponse200DiskBackupPolicy';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskDiskBackupPoliciesPostResponse200DiskBackupPolicy';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\DisksDiskDiskBackupPoliciesPostResponse200DiskBackupPolicy();
        ...
        if (\array_key_exists('schedule', $data)) {
            $object->setSchedule($this->denormalizer->denormalize($data['schedule'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PostDiskDiskBackupPolicies200ResponseDiskBackupPolicySchedule', 'json', $context));
            unset($data['schedule']);
        }
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskDiskBackupPoliciesPostResponse200DiskBackupPolicy' => false];
    }
}
