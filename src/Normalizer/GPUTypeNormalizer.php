...
class GPUTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\GPUType';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\GPUType';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\GPUType();
        ...
        if (\array_key_exists('data_centers', $data)) {
            ...
            foreach ($data['data_centers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Krystal\\Katapult\\KatapultAPI\\Model\\DataCenter', 'json', $context);
            }
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\GPUType' => false];
    }
}
