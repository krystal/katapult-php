...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DeleteDisk200ResponseDiskInstallationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteDisk200ResponseDiskInstallation';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteDisk200ResponseDiskInstallation';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Krystal\Katapult\KatapultAPI\Model\DeleteDisk200ResponseDiskInstallation();
        ...
        {
            return ['Krystal\\Katapult\\KatapultAPI\\Model\\DeleteDisk200ResponseDiskInstallation' => false];
        }
    }
} else {
    class DeleteDisk200ResponseDiskInstallationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
