...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DisksDiskUnassignPostResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskUnassignPostResponse200Disk';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskUnassignPostResponse200Disk';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Krystal\Katapult\KatapultAPI\Model\DisksDiskUnassignPostResponse200Disk();
            ...
            if (\array_key_exists('io_profile', $data) && $data['io_profile'] !== null) {
                $object->setIoProfile($this->denormalizer->denormalize($data['io_profile'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PostDiskUnassign200ResponseDiskIoProfile', 'json', $context));
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PostDiskUnassignPartDataCenter', 'json', $context));
                unset($data['data_center']);
            }
            if (\array_key_exists('virtual_machine_disk', $data) && $data['virtual_machine_disk'] !== null) {
                $object->setVirtualMachineDisk($this->denormalizer->denormalize($data['virtual_machine_disk'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PostDiskUnassign200ResponseDiskVirtualMachineDisk', 'json', $context));
            ...
            if (\array_key_exists('installation', $data) && $data['installation'] !== null) {
                $object->setInstallation($this->denormalizer->denormalize($data['installation'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PostDiskUnassign200ResponseDiskInstallation', 'json', $context));
        ...
        {
            return ['Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskUnassignPostResponse200Disk' => false];
        }
    }
} else {
    class DisksDiskUnassignPostResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
