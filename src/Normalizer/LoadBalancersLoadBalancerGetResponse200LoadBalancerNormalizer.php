    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('ip_address', $data)) {
            ...
            foreach ($data['ip_address'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Krystal\\Katapult\\KatapultAPI\\Model\\GetLoadBalancerPartIPAddress', 'json', $context);
            }
        ...
        if (\array_key_exists('weights', $data)) {
            ...
            foreach ($data['weights'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Krystal\\Katapult\\KatapultAPI\\Model\\GetLoadBalancerPartWeights', 'json', $context);
            }
