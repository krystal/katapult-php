...
class LoadBalancersLoadBalancerPatchResponse200LoadBalancerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('data_center', $data)) {
            $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchLoadBalancerPartDataCenter', 'json', $context));
        ...
        if (\array_key_exists('weights', $data)) {
            ...
            foreach ($data['weights'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchLoadBalancerPartWeights', 'json', $context);
            }
