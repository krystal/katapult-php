...
class PatchVirtualMachine200ResponseVirtualMachinePackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachine200ResponseVirtualMachinePackage';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachine200ResponseVirtualMachinePackage';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\PatchVirtualMachine200ResponseVirtualMachinePackage();
        ...
        if (\array_key_exists('icon', $data) && $data['icon'] !== null) {
            $object->setIcon($this->denormalizer->denormalize($data['icon'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartPackageIcon', 'json', $context));
            unset($data['icon']);
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachine200ResponseVirtualMachinePackage' => false];
    }
}
