...
class LoadBalancersRulesLoadBalancerRulePatchResponse200LoadBalancerRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\LoadBalancersRulesLoadBalancerRulePatchResponse200LoadBalancerRule';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\LoadBalancersRulesLoadBalancerRulePatchResponse200LoadBalancerRule';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\LoadBalancersRulesLoadBalancerRulePatchResponse200LoadBalancerRule();
        ...
        if (\array_key_exists('certificates', $data)) {
            ...
            foreach ($data['certificates'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchLoadBalancersRulesLoadBalancerRulePartCertificates', 'json', $context);
            }
        ...
        if (\array_key_exists('load_balancer', $data)) {
            $object->setLoadBalancer($this->denormalizer->denormalize($data['load_balancer'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchLoadBalancersRulesLoadBalancerRulePartLoadBalancer', 'json', $context));
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\LoadBalancersRulesLoadBalancerRulePatchResponse200LoadBalancerRule' => false];
    }
}
