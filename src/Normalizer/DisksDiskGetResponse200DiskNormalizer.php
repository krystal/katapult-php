...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DisksDiskGetResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskGetResponse200Disk';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskGetResponse200Disk';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Krystal\Katapult\KatapultAPI\Model\DisksDiskGetResponse200Disk();
            ...
            if (\array_key_exists('data_center', $data)) {
                $object->setDataCenter($this->denormalizer->denormalize($data['data_center'], 'Krystal\\Katapult\\KatapultAPI\\Model\\GetDiskPartDataCenter', 'json', $context));
        ...
        {
            return ['Krystal\\Katapult\\KatapultAPI\\Model\\DisksDiskGetResponse200Disk' => false];
        }
    }
} else {
    class DisksDiskGetResponse200DiskNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
