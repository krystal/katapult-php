...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PolicyFeaturesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeatures';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeatures';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Krystal\Katapult\KatapultAPI\Model\PolicyFeatures();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('disk_bus_configuration', $data)) {
                $object->setDiskBusConfiguration($this->denormalizer->denormalize($data['disk_bus_configuration'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeature', 'json', $context));
                unset($data['disk_bus_configuration']);
            }
            if (\array_key_exists('zone_selection', $data)) {
                $object->setZoneSelection($this->denormalizer->denormalize($data['zone_selection'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeature', 'json', $context));
                unset($data['zone_selection']);
            }
            if (\array_key_exists('restricted_traffic_types', $data)) {
                $object->setRestrictedTrafficTypes($this->denormalizer->denormalize($data['restricted_traffic_types'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeature', 'json', $context));
                unset($data['restricted_traffic_types']);
            }
            if (\array_key_exists('suspension', $data)) {
                $object->setSuspension($this->denormalizer->denormalize($data['suspension'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeature', 'json', $context));
                unset($data['suspension']);
            }
            if (\array_key_exists('flexible_virtual_machine_resources', $data)) {
                $object->setFlexibleVirtualMachineResources($this->denormalizer->denormalize($data['flexible_virtual_machine_resources'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeature', 'json', $context));
        ...
        {
            return ['Krystal\\Katapult\\KatapultAPI\\Model\\PolicyFeatures' => false];
        }
    }
} else {
    class PolicyFeaturesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
