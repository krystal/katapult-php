...
class GetVirtualMachinePartOrganizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('country', $data)) {
            $object->setCountry($this->denormalizer->denormalize($data['country'], 'Krystal\\Katapult\\KatapultAPI\\Model\\GetVirtualMachinePartCountry', 'json', $context));
            unset($data['country']);
        }
        if (\array_key_exists('country_state', $data)) {
            $object->setCountryState($this->denormalizer->denormalize($data['country_state'], 'Krystal\\Katapult\\KatapultAPI\\Model\\GetVirtualMachinePartCountryState', 'json', $context));
