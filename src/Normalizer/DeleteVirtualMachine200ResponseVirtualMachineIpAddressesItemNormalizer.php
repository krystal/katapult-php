...
class DeleteVirtualMachine200ResponseVirtualMachineIpAddressesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachine200ResponseVirtualMachineIpAddressesItem';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachine200ResponseVirtualMachineIpAddressesItem';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\DeleteVirtualMachine200ResponseVirtualMachineIpAddressesItem();
        ...
        if (\array_key_exists('network', $data)) {
            $object->setNetwork($this->denormalizer->denormalize($data['network'], 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachinePartIPAddressesNetwork', 'json', $context));
            unset($data['network']);
        }
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachine200ResponseVirtualMachineIpAddressesItem' => false];
    }
}
