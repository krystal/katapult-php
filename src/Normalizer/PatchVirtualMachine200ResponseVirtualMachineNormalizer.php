...
class PatchVirtualMachine200ResponseVirtualMachineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('zone', $data)) {
            $object->setZone($this->denormalizer->denormalize($data['zone'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartZone', 'json', $context));
            unset($data['zone']);
        }
        if (\array_key_exists('organization', $data)) {
            $object->setOrganization($this->denormalizer->denormalize($data['organization'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartOrganization', 'json', $context));
            unset($data['organization']);
        }
        if (\array_key_exists('group', $data)) {
            $object->setGroup($this->denormalizer->denormalize($data['group'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartGroup', 'json', $context));
            unset($data['group']);
        }
        if (\array_key_exists('package', $data)) {
            $object->setPackage($this->denormalizer->denormalize($data['package'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartPackage', 'json', $context));
            unset($data['package']);
        }
        if (\array_key_exists('attached_iso', $data)) {
            $object->setAttachedIso($this->denormalizer->denormalize($data['attached_iso'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartAttachedISO', 'json', $context));
        ...
        if (\array_key_exists('gpu_type', $data)) {
            $object->setGpuType($this->denormalizer->denormalize($data['gpu_type'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartGPUType', 'json', $context));
            unset($data['gpu_type']);
        }
        if (\array_key_exists('gpus', $data)) {
            $values = [];
            foreach ($data['gpus'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartGPUs', 'json', $context);
            }
        ...
        if (\array_key_exists('tags', $data)) {
            ...
            foreach ($data['tags'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartTags', 'json', $context);
            }
        ...
        if (\array_key_exists('ip_addresses', $data)) {
            ...
            foreach ($data['ip_addresses'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Krystal\\Katapult\\KatapultAPI\\Model\\PatchVirtualMachinePartIPAddresses', 'json', $context);
            }
