...
class GpuTypesGpuTypeGetResponse200GpuTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\GpuTypesGpuTypeGetResponse200GpuType';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\GpuTypesGpuTypeGetResponse200GpuType';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\GpuTypesGpuTypeGetResponse200GpuType();
        ...
        if (\array_key_exists('data_centers', $data)) {
            ...
            foreach ($data['data_centers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Krystal\\Katapult\\KatapultAPI\\Model\\GetGPUType200ResponseGPUTypeDataCentersItem', 'json', $context);
            }
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\GpuTypesGpuTypeGetResponse200GpuType' => false];
    }
}
