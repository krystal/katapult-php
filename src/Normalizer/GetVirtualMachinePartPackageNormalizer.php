...
class GetVirtualMachinePartPackageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\GetVirtualMachinePartPackage';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\GetVirtualMachinePartPackage';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\GetVirtualMachinePartPackage();
        ...
        if (\array_key_exists('icon', $data)) {
            $object->setIcon($this->denormalizer->denormalize($data['icon'], 'Krystal\\Katapult\\KatapultAPI\\Model\\GetVirtualMachinePartIcon', 'json', $context));
            unset($data['icon']);
        }
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\GetVirtualMachinePartPackage' => false];
    }
}
