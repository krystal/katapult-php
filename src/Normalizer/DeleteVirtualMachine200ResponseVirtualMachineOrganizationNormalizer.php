...
class DeleteVirtualMachine200ResponseVirtualMachineOrganizationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachine200ResponseVirtualMachineOrganization';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachine200ResponseVirtualMachineOrganization';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\DeleteVirtualMachine200ResponseVirtualMachineOrganization();
        ...
        if (\array_key_exists('currency', $data)) {
            $object->setCurrency($this->denormalizer->denormalize($data['currency'], 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachinePartOrganizationCurrency', 'json', $context));
            unset($data['currency']);
        }
        if (\array_key_exists('country', $data) && $data['country'] !== null) {
            $object->setCountry($this->denormalizer->denormalize($data['country'], 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachinePartOrganizationCountry', 'json', $context));
            unset($data['country']);
        } elseif (\array_key_exists('country', $data) && $data['country'] === null) {
            $object->setCountry(null);
        }
        if (\array_key_exists('country_state', $data) && $data['country_state'] !== null) {
            $object->setCountryState($this->denormalizer->denormalize($data['country_state'], 'Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachinePartOrganizationCountryState', 'json', $context));
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\DeleteVirtualMachine200ResponseVirtualMachineOrganization' => false];
    }
}
