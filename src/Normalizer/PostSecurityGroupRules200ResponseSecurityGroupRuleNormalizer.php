...
class PostSecurityGroupRules200ResponseSecurityGroupRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\PostSecurityGroupRules200ResponseSecurityGroupRule';
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\PostSecurityGroupRules200ResponseSecurityGroupRule';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Krystal\Katapult\KatapultAPI\Model\PostSecurityGroupRules200ResponseSecurityGroupRule();
        ...
        if (\array_key_exists('security_group', $data)) {
            $object->setSecurityGroup($this->denormalizer->denormalize($data['security_group'], 'Krystal\\Katapult\\KatapultAPI\\Model\\PostSecurityGroupRules200ResponseSecurityGroupRuleSecurityGroup', 'json', $context));
    ...
    {
        return ['Krystal\\Katapult\\KatapultAPI\\Model\\PostSecurityGroupRules200ResponseSecurityGroupRule' => false];
    }
}
