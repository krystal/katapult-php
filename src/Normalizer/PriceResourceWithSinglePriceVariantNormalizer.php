...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PriceResourceWithSinglePriceVariantNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Krystal\\Katapult\\KatapultAPI\\Model\\PriceResourceWithSinglePriceVariant';
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === 'Krystal\\Katapult\\KatapultAPI\\Model\\PriceResourceWithSinglePriceVariant';
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Krystal\Katapult\KatapultAPI\Model\PriceResourceWithSinglePriceVariant();
            ...
            if (\array_key_exists('variants', $data)) {
                ...
                foreach ($data['variants'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'Krystal\\Katapult\\KatapultAPI\\Model\\SinglePriceVariant', 'json', $context);
                }
        ...
        {
            return ['Krystal\\Katapult\\KatapultAPI\\Model\\PriceResourceWithSinglePriceVariant' => false];
        }
    }
} else {
    class PriceResourceWithSinglePriceVariantNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
