...
class VirtualNetwork extends \Krystal\Katapult\Resources\VirtualNetwork implements ResourceInterface
{
    ...
    public static function getUrl($resourceId = null, $arguments = null)
    {
        if($resourceId)
        {
            throw new \Exception('VirtualNetwork does not support fetching a single resource');
        }
        else
        {
